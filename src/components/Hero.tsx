...
export const Hero = () => {
  ...
  return (
    <section ref={root} className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden flex items-center min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center">
        <div>
          <h1 data-hero-title className="text-5xl lg:text-7xl font-extrabold text-brand-dark mb-6 leading-[1.1]">
            <span className="block">{t.hero.greeting}</span>
            <span className="text-brand-main">{t.hero.title}</span>
          </h1>
          <h2 className="text-xl lg:text-2xl font-medium text-gray-600 mb-8 max-w-2xl">{t.hero.subtitle}</h2>
          <p data-hero-hook className="text-lg text-gray-500 mb-10 max-w-xl leading-relaxed">{t.hero.hook}</p>
        ...
        <div data-hero-portrait className="relative hidden lg:block">
